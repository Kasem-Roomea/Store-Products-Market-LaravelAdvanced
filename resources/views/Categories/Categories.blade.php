...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الأقسام الرئيسية</h4>
						</div>
					</div>
				</div>
				<!-- end header -->
                            ...
                            <div class="card">
                                    ...
                                    <div class="card-header pb-0">
                                        <div class="d-flex ">
                                            ...
                                            <a class="modal-effect btn btn-outline-success btn-blockx-small ml-4" href="{{route('exportCategories')}}">
                                                تصدير البيانات
                                            </a>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <form action="{{ route('Categories.update', 'test') }}" method="POST" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-12">
                                                                            <label for="Name"
                                                                                   class="mr-sm-2">الاسم القسم العربية</label>
                                                                        ...
                                                                        <div class="col-12">
                                                                            <label for="Name_en"
                                                                                   class="mr-sm-2">اسم القسم بالانكليزي
                                                                                :</label>
