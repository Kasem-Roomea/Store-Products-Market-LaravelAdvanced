...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">أوقات التوصيل</h4>
						</div>
					</div>
				</div>
				<!-- end header -->
                                    ...
                                    <div class="table-responsive">
                                        <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='25'>
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <th class="col-1" >الوقت المتوقع</th>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <!--edit form -->
                                                                <form action="{{ route('daysKm.update', 'test') }}" method="POST">
                                                                    {{ method_field('patch') }}
                                                                    @csrf
                                                                    <div class="row">
                                                ...
                                                <div class="modal fade" id="delete{{ $x->id }}" tabindex="-1" role="dialog"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="{{ route('daysKm.destroy', 'test') }}" method="post">
                                                                    {{ method_field('Delete') }}
                                                                    @csrf
                                                                    هل تريد حذف وقت التوصيل؟
                                                                    <input id="id" type="hidden" name="id" class="form-control"
                                                                           value="{{ $x->id }}">
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary"
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <!-- add_form -->
                                        <form action="{{ route('daysKm.store') }}" method="POST">
                                            @csrf
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="Start"
                                                ...
                                                <div class="col-12">
                                                    <label for="Time"
                                                           class="mr-sm-2">الوقت المتوقع</label>
                                                    <input id="Time" type="number" name="Time"
                                                           class="form-control"
                                                           required>
                                                </div>
